...
class FilmControllerTest {
    ...
    void validateFail() throws ValidationException {
        final Film filmFail = new Film(1, " ",
                "Мелодрамма", LocalDateTime.now().minusYears(10), 58);
        ...
        final Film filmFail2 = new Film(2, "Завтрак у Тифани",
                "Мелодраммаsdfghjkljhgfdfghjkljhgfdsfghjjhgfdfvgbnhmjjmhngbfjhgfh" +
                        ...
                        "fdghjkl;';lkjhgfdfghjklkjhgfdghjklkjhgfdghjkjhgfdgbhnmjhgfgbnhgnh" +
                        "dfgbnhmjk,l./;tfghjkljhgfdsfghjkjhgfdsfghjkhgfdsfghjkjhgfdfghjkgf" +
                        "fdghjklkjhgvdfghjkjhgfdsdfghjkjhgfdsasdfghjklkjhgfdsd" +
                        "fghjkjhgfdasdfg", LocalDateTime.now().minusYears(10), 58);
        ...
        final Film filmFail3 = new Film(3, "Breakfast by Tifany ",
                "Мелодрамма", LocalDateTime.now().minusYears(200), 58);
        ...
        final Film filmFail4 = new Film(4, "Breakfast by Tifany ",
                "Мелодрамма", LocalDateTime.now().minusYears(10), -2);
